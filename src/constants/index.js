export const myProjects = [
  {
    ...
    description: "3D parametric modeling, component mating, and dynamic motion analysis of an internal combustion engine.",
    subDescription: [
    ...
    desc: "3D parametric modeling, component mating, and dynamic motion analysis of an internal combustion engine.",
    subdesc: "Built in SolidWorks with strict engineering tolerances and interference checks.",
    ...
    texture: "/assets/projects/engine.png",
    tags: [
      {
        id: 1,
        name: "SolidWorks",
  ...
  },
  {
    ...
    description: "Complete 3D structural model and geometric constraint design for an automotive suspension assembly.",
    subDescription: [
    ...
    desc: "Complete 3D structural model and geometric constraint design for an automotive suspension assembly.",
    subdesc: "Designed using Solid Edge with a focus on load distribution, joint articulation, and chassis mounting.",
    ...
    texture: "/assets/projects/car_suspenstion.png",
    tags: [
      {
        id: 1,
        name: "Solid Edge",
  ...
  },
  {
    ...
    description: "Precision parametric rim and tire CAD design optimized for structural integrity and aerodynamics.",
    subDescription: [
    ...
    desc: "Precision parametric rim and tire CAD design optimized for structural integrity and aerodynamics.",
    subdesc: "Created in Fusion 360 utilizing advanced surface modeling and parametric feature trees.",
    ...
    texture: "/assets/projects/wheel.png",
    tags: [
      {
        id: 1,
        name: "Fusion 360",
  ...
  },
  {
    ...
    description: "Computational Fluid Dynamics (CFD) simulation examining velocity contours and pressure distribution.",
    subDescription: [
    ...
    desc: "Computational Fluid Dynamics (CFD) simulation examining velocity contours and pressure distribution.",
    subdesc: "Analyzed using ANSYS Fluent to study turbulent boundary layers and pressure drops.",
    href: "https://mathesh-mech.vercel.app",
    logo: "/assets/logos/ansys.png",
    image: "/assets/projects/converging pipe poster.jpeg",
    texture: "/assets/projects/converging pipe poster.jpeg",
    tags: [
      {
        id: 1,
        name: "ANSYS Fluent",
  ...
  },
  {
    ...
    desc: "Computational analysis of laminar flow through a constant-diameter pipe in ANSYS.",
    subdesc: "Effectively captures the development of a parabolic velocity profile and near-zero wall velocity.",
    href: "https://mathesh-mech.vercel.app",
    logo: "/assets/logos/ansys.png",
    image: "/assets/projects/laminar pipe poster.jpeg",
    texture: "/assets/projects/laminar pipe poster.jpeg",
    tags: [
      {
        id: 1,
        name: "ANSYS Fluent",
  ...
  },
  {
    ...
    description: "Performed a Static Structural analysis of a cantilever beam in ANSYS 2026 R1 (Student). Applied a point load at the free end with a fixed support at the base. Results show a maximum total deformation of 0.1925 mm at the free end, with zero deformation at the fixed support.",
    subDescription: [
      "Total Deformation: 0.1925 mm max",
      "Fixed Support + Point Force",
      "Equivalent Stress solved",
    ],
    desc: "Static Structural analysis of a cantilever beam performed in ANSYS.",
    subdesc: "Results show a maximum total deformation of 0.1925 mm at the free end with applied point load.",
    href: "https://mathesh-mech.vercel.app",
    logo: "/assets/logos/ansys.png",
    image: "/assets/projects/beam screenshot.jpeg",
    texture: "/assets/projects/beam screenshot.jpeg",
    tags: [
      {
        id: 1,
  ...
  },
  {
    ...
    description: "Conducted a NASA-validated CFD simulation of turbulent flow over a backward-facing step. Validated wall shear stress and reattachment points against empirical NASA data to ensure computational accuracy.",
    subDescription: [
    ...
    desc: "NASA-validated CFD simulation of turbulent flow over a backward-facing step.",
    subdesc: "Validated wall shear stress and reattachment points against empirical NASA data.",
    href: "https://mathesh-mech.vercel.app",
    logo: "/assets/logos/ansys.png",
    image: "/assets/projects/turbulent velocity.jpeg",
    texture: "/assets/projects/turbulent velocity.jpeg",
    tags: [
      {
        id: 1,
        name: "ANSYS Fluent",
  ...
  },
  {
    ...
    description: "Simulated the development of a laminar boundary layer over a flat plate. Successfully captured velocity contours and analyzed the boundary layer thickness growth along the length of the plate.",
    subDescription: [
    ...
    desc: "Simulated the development of a laminar boundary layer over a flat plate.",
    subdesc: "Successfully captured velocity contours and analyzed boundary layer thickness growth.",
    href: "https://mathesh-mech.vercel.app",
    logo: "/assets/logos/ansys.png",
    image: "/assets/projects/v.jpeg",
    texture: "/assets/projects/v.jpeg",
    tags: [
      {
        id: 1,
        name: "ANSYS Fluent",
  ...
  },
  {
    id: 9,
    title: "Tribute Page",
    description: "This tribute page highlights the career achievements and legacy of CR7. Built with HTML & CSS, fully responsive, and hosted live on Vercel.",
    subDescription: [
      "Tech Stack: HTML5 & CSS3",
      "Fully Responsive Design",
      "Live Deployment via Vercel",
    ],
    desc: "Tribute page highlighting the career achievements and legacy of CR7.",
    subdesc: "Built with HTML & CSS, fully responsive, and hosted live on Vercel.",
    href: "https://cr7-tribute-page.vercel.app/",
    logo: "/assets/logos/github.png", 
    image: "/assets/projects/tribute.png",
    texture: "/assets/projects/tribute.png",
    tags: [
      {
        id: 1,
